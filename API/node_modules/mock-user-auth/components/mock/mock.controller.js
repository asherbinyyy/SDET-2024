...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(name, email, password, imageUrl) {
...
function () {
  ...
  regeneratorRuntime.mark(function _callee5(token) {
    var _ref6, data, res_decode, status;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee6(token, body) {
    var _ref8, data, res_decode, status;
